...
def patients_to_slices(dataclass, patiens_num, traindataset_len, UsePercentage_flag = False):
    ...
    ref_dict = None
    ref_dict_percentage = {"1p": round(0.01*traindataset_len), "10p": round(0.1*traindataset_len), "30p": round(0.3*traindataset_len), "50p": round(0.5*traindataset_len),
...
def train(args, snapshot_path):
    ...
    # optimizer1 = optim.Adam(model1.parameters(), lr=1e-03, weight_decay=1e-05)
    # optimizer2 = optim.Adam(model2.parameters(), lr=1e-03, weight_decay=1e-05)
